...
export default class EditorRegistry {
  ...
  create(textEditor) {
    ...
    this.subscriptions.add(textEditor.onDidInsertText(() => {
        // console.log('onDidInsertText');
        // textEditor.lineTailManager.setHide(true);
    }));

    this.subscriptions.add(textEditor.onWillInsertText(() => {
    ...
    this.subscriptions.add(textEditor.onDidSave(() => {
        ...
        textEditor.lineTailManager.setHide(false);
    }));
