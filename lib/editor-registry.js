...
export default class EditorRegistry {
  ...
  create(textEditor) {
    ...
    // this.subscriptions.add(textEditor.onDidChangeScrollTop(() => {
    //     console.log('onDidChangeScrollTop');
    // }));
    //
    // this.subscriptions.add(textEditor.onDidChangeScrollLeft(() => {
    //     console.log('onDidChangeScrollLeft');
    // }));
